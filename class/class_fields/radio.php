...
class Radio extends Field {
    ...
    {   
        ...
        if ($edit_form==true) {
            ...
            $html .= "Group checkbox: <input name='group_with' type='button' onclick='add_optionsORgroups()' value='Add'> 
                     <input id='amount_options' type='text' value='0' maxlength='2' style='width: 50px'>
                    <input name='clear_group_with' type ='button' onclick='clear_options()' value='Clear'><br>";
            $html .= "";
